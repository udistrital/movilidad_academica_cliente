...
@Component({
  selector: 'ngx-list-tipocategoria',
  templateUrl: './list-tipocategoria.component.html',
  styleUrls: ['./list-tipocategoria.component.scss'],
  })
export class ListTipocategoriaComponent implements OnInit {
  uid: number;
  ...
  onDelete(event): void {
    ...
    .then((willDelete) => {
      ...
      if (willDelete.value) {
        this.movilidadAcademicaService.delete('tipocategoria/', event.data).subscribe(res => {
          if (res !== null) {
            this.loadData();
            this.showToast('info', 'deleted', 'Tipocategoria deleted');
            }
         });
      }
    });
