...
export const Config = {
    LOCAL: {
        ...
        DOCUMENTO_SERVICE: 'https://autenticacion.udistrital.edu.co/apioas/convenio_crud_api/v1/',
        CONVENIO_SERVICE: 'https://autenticacion.udistrital.edu.co/apioas/convenio_crud_api/v1/',
        MOVILIDAD_ACADEMICA_SERVICE: 'https://autenticacion.udistrital.edu.co/apioas/movilidad_crud_api/v1/',
        MOVILIDAD_ACADEMICA_SERVICE_MID: 'https://autenticacion.udistrital.edu.co/apioas/movilidad_mid_api/v1/',
